...
class ResnetClassifier : public AbstractImageClassifier
{
public:
	...
	/// </param>
	/// <param name="mean">
	/// The mean to use during normalization. Defaults to the mean appropriate for Yahoo's Open NSFW
	...
	/// Default dtor.
	/// </summary>
	virtual ~ResnetClassifier() noexcept;
...
private:
	...
	/// <summary>
	/// The default mean. This value is meant to be used with Yahoo's open NSFW model. 
	/// </summary>
